...
(def (definer e :available-flags "e") computed-universe (name-and-args &optional supers slots &rest class-options)
  (%expand-computed-universe-definition name-and-args supers slots (getf -options- :export) class-options))

(def (macro e) define-computed-universe (name-and-args &optional supers slots &rest class-options)
  (%expand-computed-universe-definition name-and-args supers slots #f class-options))
...
(def function %expand-computed-universe-definition (name supers slots export? class-options)
  ...
  (bind (((name &key
                ...
                (current-value-variable-name '-current-value-)) (ensure-list name))
    ...
    `(progn
       (eval-always
         ...
         (defclass ,name ,(append supers '(computed-universe))
           ,slots
           ,@class-options
           (:metaclass computed-universe-class)
